...
import {AddUnivModal} from './addUniversite';
import {EditUnivModal} from './editUniversite';
         ...
         <div className="animated fadeIn">
           <Row>
              <Col>
                <Card>
                  <CardHeader>
                    <i className="fa fa-align-justify"></i> La liste des événements
                  </CardHeader>
                  
                  <CardBody>
                    
                    <ButtonToolbar>
                      <Button variant='primary' onClick={()=> this.setState({addModalShow: true})}  >Ajouter événement </Button>  
                      <AddUnivModal show={this.state.addModalShow} onHide={addModalClose}/>
                    </ButtonToolbar>
